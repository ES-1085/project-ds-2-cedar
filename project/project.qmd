...
hpsa_pc_provider_counts <- ahrf_2019_2023 %>% 
  ...
  drop_na(pc_physician_count_year, pc_physician_count, md_pc_count_year, md_pc_count, do_pc_count_year, do_pc_count) %>% 
  distinct(county_name, pc_physician_count_year, md_pc_count_year, do_pc_count_year, .keep_all = TRUE)
