...
care_types %>% 
  ...
  theme_minimal() +
  facet_wrap(~ cnty_name, scales = "free", ncol = 3) +
...
all_physicians %>% 
  ...
  geom_smooth(method = "lm", color = "#AADB41") +
  geom_line(alpha = 0.8, color = "#006992") +
  theme_minimal() +
  scale_y_continuous(labels = label_comma()) +
...
```{r all-physicians-family-med-do}
all_physicians %>% 
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "Family Medicine Doctor (DO) Count", subtitle = "By Maine County", x = "County", y = "Count") +
  facet_wrap(~ physician_count_year, scales = "free")
...
all_physicians %>% 
  ...
  theme_minimal() +
  scale_y_continuous(labels = label_comma()) +
  labs(title = "Family Medicine Doctor (DO) Count", subtitle = "By Maine County", x = "Year", y = "Count", caption = "Family medicine doctor count was divided by county population as of the 2020 Census") +
  facet_wrap(~ county_name)
```

```{r all-physicians-pediatricians-do}
all_physicians %>% 
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "Pediatrician (DO) Count", subtitle = "By Maine County", x = "County", y = "Count") +
  facet_wrap(~ physician_count_year, scales = "free")
...
all_physicians %>% 
  ...
  theme_minimal() +
  scale_y_continuous(labels = label_comma()) +
  labs(title = "Pediatrician (DO) Count", subtitle = "By Maine County", x = "Year", y = "Count", caption = "Pediatrician count was divided by county population as of the 2020 Census") +
  facet_wrap(~ county_name)
```

```{r all-physicians-obgyns-do}
all_physicians %>% 
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "OBGYN (DO) Count", subtitle = "By Maine County", x = "County", y = "Count") +
  facet_wrap(~ physician_count_year, scales = "free")
...
all_physicians %>% 
  ...
  theme_minimal() +
  scale_y_continuous(labels = label_comma()) +
  labs(title = "OBGYN (DO) Count", subtitle = "By Maine County", x = "Year", y = "Count", caption = "OBGYN count was divided by county population as of the 2020 Census") +
  facet_wrap(~ county_name)
```

```{r all-physicians-gen-surg-do}
all_physicians %>% 
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "General Surgeon (DO) Count", subtitle = "By Maine County", x = "County", y = "Count") +
  facet_wrap(~ physician_count_year, scales = "free")
...
all_physicians %>% 
  ...
  theme_minimal() +
  scale_y_continuous(labels = label_comma()) +
  labs(title = "General Surgeon (DO) Count", subtitle = "By Maine County", x = "Year", y = "Count", caption = "General surgeon count was divided by county population as of the 2020 Census") +
  facet_wrap(~ county_name)
```

```{r all-physicians-emergency-med-do}
all_physicians %>% 
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "Emergency Medicine Doctor (DO) Count", subtitle = "By Maine County", x = "County", y = "Count") +
  facet_wrap(~ physician_count_year, scales = "free")
...
all_physicians %>% 
  ...
  theme_minimal() +
  scale_y_continuous(labels = label_comma()) +
  labs(title = "Emergency Medicine Doctor (DO) Count", subtitle = "By Maine County", x = "Year", y = "Count", caption = "Emergency medicine doctor count was divided by county population as of the 2020 Census") +
  facet_wrap(~ county_name)
```

```{r all-physicians-psychiatrists-do}
all_physicians %>% 
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = "Psychiatrist (DO) Count", subtitle = "By Maine County", x = "County", y = "Count") +
  facet_wrap(~ physician_count_year, scales = "free")
...
all_physicians %>% 
  ...
  theme_minimal() +
  scale_y_continuous(labels = label_comma()) +
  labs(title = "Psychiatrist (DO) Count", subtitle = "By Maine County", x = "Year", y = "Count", caption = "Psychiatrist count was divided by county population as of the 2020 Census") +
  facet_wrap(~ county_name)
```
...
(pc_provider_change <- linear_reg() %>% 
  set_engine("lm") %>% 
  fit(pc_physician_count ~ pc_physician_count_year + county_name, data = hpsa_pc_provider_counts))
