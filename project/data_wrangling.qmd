...
```{r joins_with_county_poverty_ranking}
all_physicians <- all_physicians %>% 
  left_join(county_poverty_rankings)

hpsa_pc_provider_counts <- hpsa_pc_provider_counts %>% 
  left_join(county_poverty_rankings)

dental_care <- dental_care %>% 
  left_join(county_poverty_rankings, by = c("cnty_name" = "county_name"))
